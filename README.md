...
To build _Runtime Detection for SOA_ requires specific versions of Java and
...
_Runtime Detection for SOA_ is open source, and we welcome anybody that wants to
